 ...
 */
public class AWSBuilderConfigurator<BuilderT extends AwsSyncClientBuilder<BuilderT,ClientT> & AwsClientBuilder<BuilderT,ClientT>, ClientT>{
	...
	private static final String AWS_HEADER_VALUE = "Mendix-Authentication-3.2.1";
	...
	public AWSBuilderConfigurator(final BuilderT builderT) {
	 ...
	 */
	public AWSBuilderConfigurator<BuilderT,ClientT> setAbstractRequest(final AbstractRequest abstractRequest) {
	 ...
	 * @return ClientGeneratorBuilder<BuilderT>
	 */
	public AWSBuilderConfigurator<BuilderT,ClientT> setRegion(final ENUM_Region region) {
		this.region = region;
		return this;
	}
	 ...
	 * @return ClientGeneratorBuilder<BuilderT>
	 */
	public AWSBuilderConfigurator<BuilderT,ClientT> setCredentials(final Credentials credentials) {
		this.credentials = credentials;
		return this;
	}
			
	public AWSBuilderConfigurator<BuilderT,ClientT> setAwsHeaderValue(final String awsHeaderValue) {
