 ...
 */
public class Module_GetMicroflowList_PostProcessing extends UserAction<java.util.List<IMendixObject>>
{
	...
	public Module_GetMicroflowList_PostProcessing(
		IContext context,
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try {
			...
			List<Microflow> microflowList = Core.getMicroflowNames().stream()
				...
				.filter(microflow -> Core.getReturnType(microflow).getType().equals(IDataType.DataTypeEnum.Nothing))
				.sorted()
	...
	{
		return "Module_GetMicroflowList_PostProcessing";
	}
