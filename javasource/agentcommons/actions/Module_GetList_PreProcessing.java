 ...
 */
public class Module_GetList_PreProcessing extends UserAction<java.util.List<IMendixObject>>
{
	...
	public Module_GetList_PreProcessing(
		IContext context,
	...
	{
		return "Module_GetList_PreProcessing";
	}

	// BEGIN EXTRA CODE
	private static final MxLogger LOGGER = new MxLogger(Module_GetList_PreProcessing.class);
